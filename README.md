...
Over 300 held-out random careers, the 2M-step agent reaches **Série A ~72%** of
the time and is **fired in 0%** of them (vs. 58% for the greedy baseline), with
mean return 5.4 vs 0.4. Winning the Série A title (2.7%) is the remaining
frontier. Full table + hard-mode numbers in [`RESULTS.md`](RESULTS.md).
